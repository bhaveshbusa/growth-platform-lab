...
`git switch main`, delete `.learning/progress.json`, and (from phase 2 onward) `docker compose down -v` to drop containers and data volumes. The orientation step detects prior state and offers this.
